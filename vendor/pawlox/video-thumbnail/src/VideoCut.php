...
class VideoCut {
    ...
    public function createCut($videoUrl, $storageUrl, $fileName) {
    ...
    private function cutvideo() {
        Log::debug('Chay den day khong FRAME 0 ?');
        $clip = $video->clip(Coordinate\TimeCode::fromSeconds(30),Coordinate\TimeCode::fromSeconds(15));
        Log::debug('Chay den day khong FRAME 1?');
        $clip->save(new FFMpeg\Format\Video\X264(), $fullFile);
